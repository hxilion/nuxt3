<template>
	<div class="photo text-color-1 font-medium" style="background-color: #902BF5;width:100%;font-family:'M PLUS 2'">
		...
		<div>
			<img src="/assets/img/email/kyc-success-m.png" alt="">
			<div class="text-sm text-left text-start font-medium py-10 px-5" style="background-color: #fff;">
				<div class="mb-10">
					%user_name% 様
				</div>
				<div class="mb-10">
					お世話になっております。弊社のウェブサイトにて本人確認認証を完了いただき、誠にありがとうございます！
				</div>
				<div>
					以下の書類が正確に提出され、本人確認が完了しました。
				</div>
				<div class="mb-10">
					<ul>
						<li>パスポート（有効期限：yyyy年mm月dd日）</li>
						<li>運転免許証（有効期限：yyyy年mm月dd日）</li>
					</ul>
				</div>
				<div class="divide-x mb-14"></div>
				<div class="mb-14">
					ご協力いただき、誠にありがとうございました。引き続き、安全で安心なサービスをご利用いただけます。
				</div>
				<div class="mb-5">
