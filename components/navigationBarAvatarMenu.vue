<template>
  <div>
    <Menu as="div" class="relative inline-block text-left">
      ...
      >
        <MenuItems
          class="absolute right-0 mt-2 w-56 origin-top-right border-l-4 border-primary divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
        >
          <div class="px-1 py-1">
